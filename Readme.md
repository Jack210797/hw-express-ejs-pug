...
Також у оновленому коді добавлено об'єкт проекції, який вказує, які поля повертати (1) або не повертати (0). Метод find тепер використовує цю проекцію як другий аргумент.
